...
public class MmpmDynamicService implements IDynamicService{

	private static final String TYPE = "mmpm";
	
	private static final String REQUESTMODEL = "channel=0001&imsi={imsi}&imei={imei}&code={code}&extData=test";
	...
	public String dynamic(Map<String, String> map) {
		...
		if(url != null && url.length() > 0){
			...
			param = param.replace("{code}", StringUtils.defaultString(map.get("code")));
	...
	private String parseXml(Map<String,String> map,String responseXml){
		...
		if(responseXml != null && responseXml.length() > 10){
	...
	public static void main(String[] args){
		...
		map.put("code","20141204757202");
		map.put("url","http://121.41.107.42/mmpm/getPay");
		
		System.out.println(new MmpmDynamicService().dynamic(map));
	}
