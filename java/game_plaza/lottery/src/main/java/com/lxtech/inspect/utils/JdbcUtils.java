package com.lxtech.inspect.utils;
...
public class JdbcUtils {
	...
	private static ComboPooledDataSource mjds = null;
	...
	// 在静态代码块中创建数据库连接池
	static {
		ds = getDataSourceByConfig("/config/statsdb.properties");
		mjds = getDataSourceByConfig("/config/majiang_shell.properties");
//		goDs = getDataSourceByConfig("/config/godb.properties");
//		payDs = getDataSourceByConfig("/config/paydb.properties");
	}
	...
	public static DataSource getMjDataSource() {
		// 从数据源中获取数据库连接
		return mjds;
	}
...
//	}
//	
//	public static DataSource getPayDataSource() {
//		return payDs;
//	}
