            ...
            function(w) {
                ...
                if (w.code == 0) {
                    ...
                    if(reg.test( w.thumb )){
                        ...
                        var imgpath = Path.path+'/statics/uploads/'+ w.thumb;
                    }
                    if (w.img!='photo/member.jpg') {
                        s.removeClass("rNow").removeClass("rFirst").html('<a href="/mobile/mobile/dataserver/'+s.id+'"></a><li class="revConL">' + x + '<img src="'+ imgpath + '"></li><li class="revConR"><dl><dd class="touxianga"><img src="'+Path.path+'/statics/uploads/'+ w.img +'"></dd><dd>获得者：<em class="blue">' + w.user + '</em><br>购买：<em class="orange arial">' + w.buyCount + '</em>人次</dd></dl><dt>幸运码：<em class="orange arial">' + w.codeRNO + '</em><br>揭晓时间：<em class="c9 arial">' + w.codeRTime + '</em></dt><b class="fr z-arrow"></b></li>');
                       
                    } else if(w.headimg!=''){
                        s.removeClass("rNow").removeClass("rFirst").html('<a href="/mobile/mobile/dataserver/'+s.id+'"></a><li class="revConL">' + x + '<img src="' + imgpath + '"></li><li class="revConR"><dl><dd class="touxianga"><img src="'+w.headimg+'"></dd><dd>获得者：<em class="blue">' + w.user + '</em><br>购买：<em class="orange arial">' + w.buyCount + '</em>人次</dd></dl><dt>幸运码：<em class="orange arial">' + w.codeRNO + '</em><br>揭晓时间：<em class="c9 arial">' + w.codeRTime + '</em></dt><b class="fr z-arrow"></b></li>');
