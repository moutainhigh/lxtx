...
<form name="myform" action="" method="post" enctype="multipart/form-data">
  <table width="100%" cellspacing="0">
		<tr>
			...
			<td>
				<input type="text" name="title" value="<?php echo $recomone['title'];?>" class="input-text wid300" /><span><font color="#0c0" size="">※ </font>调用方式---{wc:fun:Getindexad('推荐位名称')}。如有多个推荐位名称相同的，则全部调用出来（用于幻灯）</span>
			</td>
		</tr>
		<tr>
