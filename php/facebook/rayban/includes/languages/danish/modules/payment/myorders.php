...
//card info
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_CREDIT_CARD_NUMBER', 'Kort nummer:' );
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_CREDIT_CARD_CVV', 'CVV2/CSC:' );
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_MONTH', 'Måned' );
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_YEAR', 'År' );
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_NAME', 'Navn på kort' );
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_CARD', 'Kreditkort' );
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_CREDIT_CARD_EXPIRES', 'Udløbsdato:' );

//js info
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_JS_MYORDERS_NAME', '* Navn er påkrævet!\n' );
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_JS_MYORDERS_NUMBER', '* Card No. Er Fejl!\n' );
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_JS_MYORDERS_NUMBER_01', '* Ugyldigt Kortnummer! \n' );
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_JS_MYORDERS_EXPIRES_MONTH', '* Kreditkort Udløber måned Fejl!\n' );
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_JS_MYORDERS_EXPIRES_YEAR', '* Kreditkort Udløber År Er Fejl!\n' );
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_ERROR', 'Kreditkort Fejl:' );
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_JS_MYORDERS_CVV', '*CVV2 / CSC er Error!\n' );
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_JS_MYORDERS_CVV_01', '*CVV2 / CSC er påkrævet og skal være nummer!\n' );
//Gateway info
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_PENDING', 'Din betaling er i behandling. Vi vil sende dig resultatet af det. Vent tålmodigt, tak.' );
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_FAILURE', 'Meget ked af. Din udstedende bank eller kreditkortselskab sagde \'@@@\'. Prøv at kontakte din udstedende bank eller brug et andet kort, og prøv igen.' );
...
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_SUCCESS', 'Din betaling blev succesfuldt behandlet.' );
