...
<script src="<c:url value='/scripts/prepare.js?t=${version}' />"></script>
...
<body>
	...
	<div class="transaction">
		...
		<div class="deal-btn-wrap">
			...
			<p>服务时间：每天9:00~次日凌晨4:00 每日4:00~9:00暂停服务</p>
		</div>
	...
	<script type="text/javascript">
		...
		(function(root) {
            ...
            .splitServerAndGoodList('{"Servers":[{"ServerId":13,"ServerIP":"119.29.98.103","ServerPort":8081,"ServerName":"点差宝155web行情2","ServerType":3,"ServerParam":""},'
					...
					+ '"Merchs":[{"MarketId":17000,"MerchCode":"BTC","Name":"比特币","UnitNum":1,"ShowUnit":"吨","Dec":0,"Margin":"10,100,500","FreezeTime":60,"Point":"80,13|120,11|160,7.5","MaxBuyNum":6},'
					+ '{"MarketId":17000,"MerchCode":"LTC","Name":"莱特币","UnitNum":1,"ShowUnit":"千克","Dec":0,"Margin":"10,100,500","FreezeTime":60,"Point":"80,13|120,11|160,7.5","MaxBuyNum":6}],'
	...
	<script src="<c:url value='/scripts/util.js?t=1232323' />"></script>
	<script src="<c:url value='/scripts/net3.js?t=${version}' />"></script>
				...
				function() {
					...
					$("#guide_slide").click(
							function() {
								...
								if (imgidx < 8) {
									var basesrc = imgsrc.substr(0,index1 + 1);
									var nextImgSrc = basesrc
										+ (imgidx + 1) + ".png";
					...
					$("#previous").click(
				 	...
				 	$.get(appath + "/user/getCurrentUser", {
						...
						if (d.firstVisit == 0) {
							var imageSrc = "";
							if(d.subjectCount=='3'){
								imageSrc = appath+"/images/newbie/1.png";
							}else if(d.subjectCount=='2'){
								imageSrc = appath+"/images/newbie2/1.png";
							}
							$("#guide_slide").attr("src",imageSrc);
							popupDiv('pop-div');
						}else{
							setTimeout(function(){
								checkNotice();
