...
function showBank(){
	...
	layer_get_chips_background.x = converToParentX(640, SCREEN_WIDTH);
	baseLayer.addChild(layer_get_chips_background);
	layer_get_chips_background.graphics.drawRect(1, "#223850", [0, 0, 640, 585], true, "#223850");
	...
	*/
	...
	layer_save_chips_title_background.graphics.drawRect(1, "#1c324a", [0, 90, 640, 70], true, "#1c324a");
	...
	*/
	...
	layer_get_money_title_background.graphics.drawRect(1, "#1c324a", [0, 330, 640, 70], true, "#1c324a");
