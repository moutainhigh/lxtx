 ...
 class send extends SystemAction {
	...
	*/
	public function send_shop_code(){
		generate_log_product("in send_shop_code.".$_POST['send']."  ".$_POST['uid']."  ".$_POST['gid']."   abc");
		...
		generate_log_product("load send type :".$type);
		...
		generate_log_product("in send.action.php, send type is:".$type);
