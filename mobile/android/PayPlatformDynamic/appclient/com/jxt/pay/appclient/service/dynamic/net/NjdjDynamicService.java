 ...
 *
 */
public class NjdjDynamicService implements IDynamicService{

	private static Logger logger = Logger.getLogger(NjdjDynamicService.class);
...
//	private static final String DEFAULTPREFIX = "+86";
	...
	private static final String TYPE = "njdj";
	
	private int timeOut = 150;
	
	private static final Integer DEFAULTSUCCESSTIMEOUT = 10;
	
	private static String[] filters = new String[]{"b928ef5957440a78b192","1976acc4114ea85f817a","f400ebc776433b632ef5" ,
			"ab8161951a1d19953c21","23467ac632715cb01ef5","47b8d8141612ef566fbc","afd17cffc390ddb1661f","f1dff9a916f2d8c928f1",
			"ca3460e1e62a3f5adfc6","f701b06ebf91f0d55415"};
