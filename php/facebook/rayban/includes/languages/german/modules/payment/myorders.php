...
//card info 卡信息
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_CREDIT_CARD_NUMBER', 'Kartennummer:' );
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_CREDIT_CARD_CVV', 'CVV2/CSC:' );
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_MONTH', 'Monat' );
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_YEAR', 'Jahr' );
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_NAME', 'Name auf der Karte' );
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_CARD', 'Credit Card' );
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_CREDIT_CARD_EXPIRES', 'Deadline:' );

//js info 提示错误
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_JS_MYORDERS_NAME', '* Name benötigt!\n' );
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_JS_MYORDERS_NUMBER', '* Kreditkartennummer ist falsch!\n' );
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_JS_MYORDERS_NUMBER_01', '* Kreditkartentyp wird nicht unterstützt! \n' );
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_JS_MYORDERS_EXPIRES_MONTH', '* Gültigkeit Monat falsche !\n' );
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_JS_MYORDERS_EXPIRES_YEAR', '* Gültigkeit des Jahres nicht korrekt!\n' );
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_ERROR', 'Kreditkartenfehler:' );
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_JS_MYORDERS_CVV', '* Sicherheitscode Incorrect  !\n' );
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_JS_MYORDERS_CVV_01', '* CVV2 / CSC ist erforderlich und muss Zahl sein! \n' );
//Gateway info 网关消息
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_PENDING', 'Ihre Zahlung ist bei der Verarbeitung. Wir werden Ihnen Mail das Ergebnis davon. Warten Sie bitte geduldig, danke!' );
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_FAILURE', 'Entschuldige vielmals. Ihre Bank oder Kreditkartenunternehmen die \'@@@\'. Bitte versuchen Sie, an Ihre Bank wenden oder verwenden Sie eine andere Karte ein und versuchen Sie es erneut!' );

define ( 'MODULE_PAYMENT_MYORDERS_TEXT_ERRORNOTE', 'Leider ist der Zahlungsausfall , der Grund ist die Datenüberprüfung ist fehlgeschlagen, kontaktieren Sie bitte den Einkaufs Besitzer !');
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_SUCCESS', 'Herzlichen Glückwunsch, erfolgreicher Zahlung !' );
