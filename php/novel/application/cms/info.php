...
return [
    ...
    'identifier'  => 'cms.ieasynet.module',
    // 模块图标[选填]
    ...
    'need_module' => [
        ['admin', 'admin.ieasynet.module', '1.0.0']
    ],
    ...
    'config' => [
        ...
        ['ckeditor', 'contact', '联系方式', '', '<div class="font-s13 push"><strong>北京浩森宇特互联科技有限公司</strong><br />
地址：北京市大兴区波普中心3号楼623<br />
电话：010-89294966<br />
邮箱：admin@ieasynet.com</div>'],
