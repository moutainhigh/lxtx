...
<form action="#" method="post">
 ...
 <input name="posttime1" type="hidden" id="posttime1" class="input-text posttime"  readonly="readonly" /> -  

 		  <input name="posttime2" type="hidden" id="posttime2" class="input-text posttime"  readonly="readonly" />
...
<input type="hidden" name="sosotext" class="input-text wid100"/>

<input class="" type="hidden" name="sososubmit" value="搜索">
...
<!-- 以上没用 -->
  ...
  [<a href="<?php echo G_ADMIN_PATH; ?>/content/channel_add">添加</a>]   
        <table width="100%" cellspacing="0">
     	...
     	<thead>
        		...
        		<tr>
                 ...
                 <th width="20%">展示商品标识</th>

                    <th width="20%">轮播图标识</th>
  ...
  <?php  
            $cgg=$this->db->GetList("SELECT * FROM `@#_channel`" );

            ?>       



        	<?php foreach($cgg as $v) : ?>
            ...
            <tr>  
                ...
                [<a href="<?php echo G_ADMIN_PATH; ?>/content/channel_edit/<?php echo $v['id'];?>">修改</a>]              

                [<a href="<?php echo G_ADMIN_PATH; ?>/content/channel_del/<?php echo $v['id'];?>">删除</a>]
