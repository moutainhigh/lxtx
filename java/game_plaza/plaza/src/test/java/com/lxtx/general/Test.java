...
public class Test {
	 ...
	 public static void main(String[] args) {
		 ...
		 String xml = "<?xml version=\"1.0\"?><response><errcode>0</errcode><errtext>success</errtext>"
		 		+ "<result>http://47.93.85.160:801/index.html?username=32489&coin=449803599&badstate=1</result></response>";
		 try {
