...
public class JdbcUtils {
	...
	private static ComboPooledDataSource ds_test = null;
	...
	// 在静态代码块中创建数据库连接池
	static {
		ds_test = getDataSourceByConfig("/config/cloudtrade_test.properties");
		ds = getDataSourceByConfig("/config/cloudtrade.properties");
	}
	 ...
	 * @return DataSource
	 */
	public static DataSource getDataTestSource() {
		// 从数据源中获取数据库连接
		return ds_test;
	}
	/**
