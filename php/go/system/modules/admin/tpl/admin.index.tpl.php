...
<div id="header">
    ...
    欢迎您：<a href="javascript:;" title="<?php echo $info['username']; ?>"><?php echo $info['username']; ?> [启源管理员]</a>
...
<div id="left">
	...
	<li class="head">站长运营</li>
     ...
     <ul class="left_date" id="shop">   
        ...
        <li><span></span><a href="javascript:void(0);" src="<?php echo G_MODULE_PATH; ?>/content/channnel_type">渠道推广列表</a></li>

        <li><span></span><a href="javascript:void(0);" src="<?php echo G_MODULE_PATH; ?>/content/goods_type">分类列表</a></li>
...
<div id="right">
	...
	<div class="right_top">
    	...
    	<a href="javascript:;" onClick="btn_iframef5();" class="system_button"><span>刷新框架</span></a>
            ...
            <a href="https://appcz.taobao.com" target="_blank" class="system_button"><span>系统开发</span></a>
