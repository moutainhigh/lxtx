 ...
 *
 */
public class ZztXlyLtDynamicService implements IDynamicService{
	private static Logger logger = Logger.getLogger(ZztXlyLtDynamicService.class);
...
//		http://cc.channel.3gshow.cn/common/req.ashx&type=zztXly&imsi=460026620811823&imei=354026050655833&mobileId=9872554&channel=100101a049397252&cid=151&pid=1113&payCodeId=5255
		...
		map.put("imei","863756028823790");
		map.put("imsi","460027614437206");
		...
		String xml = new ZztXlyLtDynamicService().dynamic(map);
