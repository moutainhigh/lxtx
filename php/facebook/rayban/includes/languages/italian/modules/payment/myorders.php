<?php
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_ADMIN_TITLE', 'MAYORDERS Payment' );
...
//card info 卡信息
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_CREDIT_CARD_NUMBER', 'Numero di carta:' );
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_CREDIT_CARD_CVV', 'CVV2/CSC:' );
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_MONTH', 'Mese' );
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_YEAR', 'Anno' );
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_NAME', 'ome sulla carta' );
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_CREDIT_CARD_EXPIRES', 'Data di scadenza:' );

//js info 提示错误
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_JS_MYORDERS_NAME', '* Il nome è obbligatorio!\n' );
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_JS_MYORDERS_NUMBER', '* Numero della carta di credito non è corretto !\n' );
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_JS_MYORDERS_NUMBER_01', '* numero della carta non valido! \n' );
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_JS_MYORDERS_EXPIRES_MONTH', '* Validità del mese non è corretto !\n' );
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_JS_MYORDERS_EXPIRES_YEAR', '* Validità dell\'anno è corretto !\n' );
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_ERROR', 'Errore carta di credito:' );
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_JS_MYORDERS_CVV', '* Codice di sicurezza non corretto !\n' );
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_JS_MYORDERS_CVV_01', '* CVV2/CSC è obbligatorio e deve essere il numero!\n' );
//Gateway info 网关消息
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_PENDING', 'L\'elaborazione dei Suoi pagamenti in corso e fra poco la mandaremo la notifica relativa al risultato dell’elaborazione. Si prega di aspettare, grazie!');
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_FAILURE', 'Molto dispiaciuto. Il Suo emittente o la Sua ditta della carta di credito ha detto \'@@@\'. Si prega di contattare il suo emittente o utilizzare una carta diversa per riprovare!' );
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_ERRORNOTE', 'Siamo spiacenti, il pagamento è il fallimento, il motivo è la convalida dei dati non riuscita, si prega di contattare il proprietario dello shopping !');
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_SUCCESS', 'Congratulazioni, il pagamento è successo !' );
