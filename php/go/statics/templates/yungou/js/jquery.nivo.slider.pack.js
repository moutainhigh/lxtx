...
(function(b) {
    var a = function(j, q) {
        ...
        var lk = Math.round((1920-d.width())/2);
        d.css("background", "url(" + m.currentImage.attr("src") + ") no-repeat -"+lk+"px 0");
        ...
        if (g.directionNav) {
			...
			b("a.nivo-prevNav", d).css("opacity",0.2).hover(function() {
				$(this).stop(true,false).animate({"opacity":"0.5"},300);
			},function() {
				$(this).stop(true,false).animate({"opacity":"0.2"},300);
			});
			b("a.nivo-nextNav", d).css("opacity",0.2).hover(function() {
				$(this).stop(true,false).animate({"opacity":"0.5"},300);
			},function() {
				$(this).stop(true,false).animate({"opacity":"0.2"},300);
			});
...
//            var lk = Math.round((1920-d.width())/2);
            if (!x) {
                r.css("background", "url(" + y.currentImage.attr("src") + ") no-repeat -"+lk+"px 0")
            } else {
                if (x == "prev") {
                    r.css("background", "url(" + y.currentImage.attr("src") + ") no-repeat no-repeat -"+lk+"px 0")
                }
                if (x == "next") {
                    r.css("background", "url(" + y.currentImage.attr("src") + ") no-repeat no-repeat -"+lk+"px 0")
                }
