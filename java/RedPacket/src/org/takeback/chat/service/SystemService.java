...
public class SystemService extends BaseService
{
    ...
    public Map<String, Object> getProxyConfig() {
        final Double money = Double.valueOf(SystemConfigService.getValue("conf_proxy_money"));
        final Double exp = Double.valueOf(SystemConfigService.getValue("conf_proxy_exp"));
