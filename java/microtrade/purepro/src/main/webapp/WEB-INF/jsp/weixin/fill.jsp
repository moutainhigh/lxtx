...
<%-- 	<script src="<c:url value='/payment/scripts/prepare.js?t=${version}' />" type="text/javascript"></script> --%>
	...
	<body>
		...
		<div class="recharge-box">
			...
			<form id="checkout" name="checkout" method="post" action="http://pay.zyhnzy.com/paycenter/appclient/getUrl.do">
        ...
        <script type="text/javascript">
            ...
            (function(root){
                ...
                (function(){
                	//hecm update  
                    var money = '20,50,100,200,300,(500),1000,2000,5000', 
//                     var money = 'NaN', 
                    ...
                    //$(".cz_but").off(tap).on(tap, _.throttle(function(e){
                        ...
                        if(chackbut){
                            ...
                            if($(".payway-wrap i.choose-full").parents("li").index() == 0){ // 微信充值
								//hecm update                            	
                            	layer.msg("抱歉：充值渠道已关闭",{time:2e3},function(){})
                            	 chackbut=true;
//                                 wxPay();
                            }
                        }
