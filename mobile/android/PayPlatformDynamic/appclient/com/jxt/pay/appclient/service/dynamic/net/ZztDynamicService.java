 ...
 *
 */
public class ZztDynamicService implements IDynamicService{
	private static Logger logger = Logger.getLogger(ZztDynamicService.class);
	private static final String TYPE = "zzt";
	private static final String URLPARAM = "imei={imei}&imsi={imsi}&iccid={iccid}&cid={cid}&amount={amount}";
