...
?>
			...
			$value['products_options_values_name']=str_replace('&lt;img','<img',$value['products_options_values_name']); 
			      $value['products_options_values_name']=str_replace('/&gt;','/ >',$value['products_options_values_name']);
...
<div class="cartInfoBlock">
        ...
        <div class="con">
            ...
            <div class="con-text">
                ...
                <div class="left margin10 textCon">
                    <p>100% safe</p>
                    Shopping is safe and secure. Guaranteed!                </div>
            ...
            <div class="con-text">
                ...
                <div class="left margin10 textCon">
                    <p>Fast delivery</p>
                    We guarantee fast shipping speed.                </div>
                <div class="clearfix"></div>
            </div>
            <div class="con-text">
                <div class="left">
                ...
                <div class="left margin10 textCon">
                    <p>100% authentic</p>
                    We offer authentic and the service 100%.                </div>
                <div class="clearfix"></div>
            </div>
        </div>
    </div>
    <div class="con-help">
            ...
            <span><a href="<?php echo zen_href_link(FILENAME_CONTACT_US);?>">Send us an Email</a></span>
            </div>
...
<div style="display: none;" class="Head-preBlock shippingBlock">
    <div class="preBox">
        ...
        <div class="preContent">
            <h3>Free delivery</h3>
            <ul>
                <li>We offer free shipping for US customers, Canada, Australia, New Zealand.</li>
                <li>Apart from these countries, we charge $ 19 for transportation costs.</li>
            </ul>

            <h3>Retours sans frais &amp; échange</h3>
            <ul>
                <li>Pour les commandes ne contenant que des lunettes de soleil ou des lunettes de prescription avec connexion 1,56 verres unifocaux, si pour une raison quelconque vous n'êtes pas satisfait de votre achat, nous offrons 100% pas de retour sans tracas dans les 30 jours. Vous obtiendrez un remboursement complet et nous même payer pour l'expédition de retour pour les clients à partir des États-Unis, Canada, Australie, Nouvelle-Zélande, la France, l'Allemagne et au Royaume-Uni. Vos lunettes retournés (soit pour le remboursement ou l'échange) doivent être portés, dans l'état où vous les recevez et dans l'emballage d'origine.</li>
                <li>Pour les lentilles multifocales contiennent des commandes, nous offrons un libre échange. Qui remboursement pour les clients de retour, nous ne pouvons le faire 50% de remboursement. Nos verres personnalisés comprennent les lentilles bifocales, les lentilles à focale variable, Haute Index 1.60 de lentilles, Haute Index de Super 1,67 de lentilles, Ultra High Index 1,74 de lentilles, des revêtements, des lunettes de soleil teintes ou de lentilles de vision unique avec des prescriptions fortes (SPH de +/- 3,00 et au-dessus).</li>
  ...
  <div class="content clear">
    ...
    <div id="CustShowPrice" class="forward clear">
      ...
      <tr>
        ...
        <td class="loading"><?php echo $cartShowTotal; ?></td>
      </tr>
      <tr >
