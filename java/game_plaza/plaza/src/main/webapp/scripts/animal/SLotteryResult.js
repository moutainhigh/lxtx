...
var lotteryResult = new Array(
	...
	new SLotteryResult(IDX_SX_NIU, 		"牛", 		new SPoint(400, 80), 		330),
	new SLotteryResult(IDX_SX_HU, 		"虎", 		new SPoint(485, 172), 	 	300),
	new SLotteryResult(IDX_SX_TU, 		"兔", 		new SPoint(515, 290), 	 	270),
	new SLotteryResult(IDX_SX_LONG, 	"龙", 		new SPoint(485, 418), 	 	240),
	new SLotteryResult(IDX_SX_SHE, 		"蛇", 		new SPoint(400, 507), 	 	210),
	new SLotteryResult(IDX_SX_MA, 		"马", 		new SPoint(282, 529), 	 	180),
	new SLotteryResult(IDX_SX_YANG, 	"羊", 		new SPoint(161, 507), 		150),
	new SLotteryResult(IDX_SX_HOU, 		"猴", 		new SPoint(70, 418), 		120),
	new SLotteryResult(IDX_SX_JI, 		"鸡", 		new SPoint(36, 290), 	 	90),
	new SLotteryResult(IDX_SX_GOU, 		"狗", 		new SPoint(76, 172), 		60),
	new SLotteryResult(IDX_SX_ZHU, 		"猪", 		new SPoint(169, 80), 	 	30),
	...
	new SLotteryResult(IDX_WX_MU, 		"木", 		new SPoint(350, 203), 		324),
	new SLotteryResult(IDX_WX_SHUI, 	"水", 		new SPoint(405, 338), 	 	252),
	new SLotteryResult(IDX_WX_HUO, 		"火", 		new SPoint(274, 426), 	 	180),
	new SLotteryResult(IDX_WX_TU, 		"土", 		new SPoint(150, 338), 	 	108)
);
