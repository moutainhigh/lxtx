...
<br class="clearBoth" />
<table width="100%" border="0" cellpadding="2" cellspacing="0" id="prevOrders">
<caption><h2><?php echo OVERVIEW_PREVIOUS_ORDERS; ?></h2></caption>
    <tr class="tableHeading">
    <th scope="col"><?php echo TABLE_HEADING_DATE; ?></th>
    <th scope="col" width="120px"><?php echo TABLE_HEADING_ORDER_NUMBER; ?></th>
...
?>
  <tr>
    ...
    <td width="90px"><?php echo TEXT_NUMBER_SYMBOL . $orders['orders_id']; ?></td>
