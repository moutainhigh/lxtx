...
<h3><?php echo TABLE_HEADING_SHIPPING_ADDRESS;//TABLE_HEADING_BILLING_ADDRESS; ?></h3>
...
<?php } ?>
  ...
  <div class="clearBoth AddTitle">
  <h3><?php echo TABLE_HEADING_BILLING_ADDRESS;//TABLE_HEADING_SHIPPING_ADDRESS; ?></h3>
  <div class="alert forward"><?php echo FORM_REQUIRED_INFORMATION; ?></div>
  </div>
  <?php
    if (ACCOUNT_GENDER == 'true') {
