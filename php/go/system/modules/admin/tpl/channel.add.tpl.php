...
<form method="post" action="" onSubmit="return CheckForm()">
	...
	<tr>
		...
		<tr>
			<td align="right" style="width:120px"><font color="red">*</font>渠道名称：</td>
     	...
     	<tr>
			...
			<td><input value="" type="text"  name="channel"  style="width:65px; padding-left:0px; text-align:center" class="input-text"></td>
		</tr>
          ...
          <tr>
			...
			<input value="<?php echo $v['id']?>" type="checkbox"  name="sgid[]" ><?php echo $v['name']?>
   ...
   <tr>
			...
			<input value="<?php echo $v['id']?>" type="checkbox"  name="pid[]" ><img src="<?php echo G_UPLOAD_PATH.'/'.$v['img'];?>" width="30" height="30">
     ...
     <tr>
       <td align="right" style="width:120px"><font color="red">*</font></td>
     <td>
