...
@WebServlet(urlPatterns = { "/gendata"})
//如果要接收浏览器的ws://协议的请求就必须实现WebSocketServlet这个类
public class WebSocketGenDataServlet extends org.apache.catalina.websocket.WebSocketServlet {
    ...
    protected StreamInbound createWebSocketInbound(String subProtocol,HttpServletRequest request) {
        return new WebSocketMessageInbound(KestrelConnector.QUEUE_NAME_GEN, maxClientId.incrementAndGet());
    }
	...
	public void init() throws ServletException {
		...
		new Thread(new KestrelMessageListener(KestrelConnector.QUEUE_NAME_GEN)).start();
	}
}