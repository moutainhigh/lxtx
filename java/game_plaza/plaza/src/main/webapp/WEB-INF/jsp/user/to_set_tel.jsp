...
<html>
	...
	<body>
		...
		<div class="forget-box">
			<div class="title">为了您的账户安全，请进行手机验证</div>
			<div class="phone-wrap table">
				<div class="table-cell"><input type="text" id="mobile" class="textvalue" pattern="[0-9]*" maxlength="11" placeholder="请输入手机号码"/></div>
				<div class="table-cell sendvalidcode-wrap"><a id="btnvalid" class="sendvalidcode">获取验证码</a></div>
			</div>
		...
		<script src="<c:url value='/scripts/settel.js?t=${version}' />" type="text/javascript"></script>
