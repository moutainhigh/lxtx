...
require_once ("./llpay/lib/llpay_core.function.php");
require_once ("./llpay/lib/llpay_md5.function.php");
require_once ("./llpay/lib/llpay_rsa.function.php");
...
class LLpayNotify {
	...
	function verifyNotify() {
		//生成签名结果
			$is_notify = true;
			include_once ('./llpay/lib/llpay_cls_json.php');
			$json = new JSON;
			...
			$oid_order = getJsonVal($val,'oid_order' );
