               ...
               // GetJPData("http://m.1yyg.com", "getUserOrderList", j(),
                ...
                function(p) {				 
                    ...
                    if (p.code == 0) {
                        ...
                        for (var l = 0; l < n; l++) {
                            var reg = /^http/i;
                            if(reg.test(o[l].thumb)){
                                var imgpath = o[l].thumb;
                            }else{
                                var imgpath = Gobal.imgpath+'/uploads/'+o[l].thumb;
                            }
                            m += "<li onclick=\"location.href='"+Gobal.Webpath+"/mobile/user/buyDetail/" + o[l].shopid +'\'"><a class="fl z-Limg" href="'+Gobal.Webpath+'/mobile/mobile/item/' + o[l].shopid +'"><img src="' + Gobal.LoadPic + '" src2="'+ imgpath + '" border=0 alt=""/></a><div class="u-gds-r gray9"><p class="z-gds-tt"><a href="'+Gobal.Webpath+'/mobile/mobile/item/' + o[l].shopid +'" class="gray6">(第' + o[l].qishu + "期)" + o[l].shopname + '</a></p><p>幸运码：<em class="orange">' + o[l].q_user_code + "</em></p><p style='margin:0px;'>揭晓时间：" + o[l].q_end_time + "</p>";
