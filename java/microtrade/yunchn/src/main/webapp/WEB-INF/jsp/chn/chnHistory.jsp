...
<script type="text/javascript">	
	...
	jQuery(function($){
		...
		jQuery(grid_selector).jqGrid({
			url:"queryForPageChnHistoryList.json",
			datatype: "json",
			postData:{
				"chnno":'${chnno}',
				"begin":$("#startDate").val(),
			...
			mtype:'GET',
			height: '420',
			colNames:[ '','渠道编号','时间','','佣金','新增关注','订单数','盈','亏','总盈利','操作'],
			colModel:[
				...
				{         name:'date1', index:'date1', align:'center',hidden:true,width:10,editable:false,sortable:false},
				...
				{         name:'loss', index:'loss', width:10,editable:false,sortable:false,sortable:false},
				{         name:'fProfit', index:'fProfit', width:10,editable:false,sortable:false,sortable:false},
				{         name:'id', index:'id', align:'center', width:20,editable:false,sortable:false,title:false,formatter:setOper,sortable:false,hidden:true,},//排序根据此index
			], 
			viewrecords : true,
			rowNum:10,
			rowList:[10,20,30],
