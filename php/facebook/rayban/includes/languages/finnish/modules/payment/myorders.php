...
//card info
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_CREDIT_CARD_NUMBER', 'Kortin numero:' );
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_CREDIT_CARD_CVV', 'CVV2/CSC:' );
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_MONTH', 'Kuukausi' );
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_YEAR', 'vuosi' );
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_NAME', 'Kortissa oleva nimi' );
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_CREDIT_CARD_EXPIRES', 'vanhenemispäivämäärä' );

//js info
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_JS_MYORDERS_NAME', '* Nimi on pakollinen!\n' );
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_JS_MYORDERS_NUMBER', '* Kortti Ei On Virhe!\n' );
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_JS_MYORDERS_NUMBER_01', '* Virheellinen Kortin numero! \n' );
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_JS_MYORDERS_EXPIRES_MONTH', '* Luottokortti Erääntyy kuukausi Virhe!\n' );
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_JS_MYORDERS_EXPIRES_YEAR', '*Luottokortti vanhenee vuoden Virhe!\n' );
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_ERROR', 'Luottokortti Virhe:' );
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_JS_MYORDERS_CVV', '* CVV2/CSC Is Error !\n' );
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_JS_MYORDERS_CVV_01', '* CVV2 / CSC on pakollinen ja sen on oltava numero! \n' );

//Gateway info
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_PENDING','Sinun maksu on jalostuksessa. Lähetämme teille sen tulosta. Odota kärsivällisesti, kiitos.' );
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_FAILURE', 'Hyvin pahoillani. Sinun myöntänyt pankki tai luottokorttiyhtiö sanoi \'@@@\'. Yritä ottaa yhteyttä kanssa myöntäneeseen pankkiin tai käytä toista korttia ja yritä uudelleen.' );
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_ERRORNOTE', 'Hyvin pahoillani. Sinun myöntänyt pankki tai luottokorttiyhtiö sanoi \'eivät kunnioita \'. Yritä ottaa yhteyttä kanssa myöntäneeseen pankkiin tai käytä toista korttia ja yritä uudelleen.');
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_SUCCESS', 'Maksun käsittely onnistui.' );
