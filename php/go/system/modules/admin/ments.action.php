...
class ments extends admin {
	...
	public function addnav(){
		if(isset($_POST['dosubmit'])){		
			...
			$catpic = htmlspecialchars($_POST['catpic']);
			$catid=intval($_POST['catid']) ? intval($_POST['catid']) : "";
			$this->db->Query("INSERT INTO `@#_navigation` (`name`, `type`, `url`, `status`,`order`,`catpic`,`catid`) VALUES ('$name','$type','$url','$status','$order','$catpic','$catid')");			
