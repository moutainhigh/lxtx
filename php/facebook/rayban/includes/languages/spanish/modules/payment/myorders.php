...
//card info 卡信息
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_CREDIT_CARD_NUMBER', 'Número de tarjeta:' );
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_CREDIT_CARD_CVV', 'CVV2/CSC:' );
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_MONTH', 'Mes' );
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_YEAR', 'Año' );
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_NAME', 'nombre en la tarjeta' );
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_CARD', 'Credit Card' );
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_CREDIT_CARD_EXPIRES', 'Tiempo de expiración:' );

//js info 提示错误
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_JS_MYORDERS_NAME', '* El nombre es necesario!\n' );
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_JS_MYORDERS_NUMBER', '* Por favor ingrese los caracteres 16-16 !\n' );
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_JS_MYORDERS_NUMBER_01', '* Invalid Card Number! \n' );
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_JS_MYORDERS_EXPIRES_MONTH', '* Validez del mes es incorrecta !\n' );
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_JS_MYORDERS_EXPIRES_YEAR', '* Validez del año es incorrecta !\n' );
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_ERROR', 'Credit Card Error:' );
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_JS_MYORDERS_CVV', '* Cvv/Código del CSC es un número de 3 dígitos !\n' );
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_JS_MYORDERS_CVV_01', '* CVV2/CSC is Required and must be number! \n' );
//Gateway info 网关消息
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_PENDING', 'Su pago de pedido está siendo procesado, y más tarde, nos notificará los resultados de su tratamiento por correspondencia. Por favor, sea paciente, gracias!' );
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_FAILURE', 'Lo siento mucho. Su banco de la apertura de la cuenta de tarjeta o compañía de tarjeta de crédito dijo \'@@@\' . Por favor, póngase en contacto con su banco de emisor de la tarjeta o utilizar diferentes tarjetas para volver a intentarlo.' );
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_ERRORNOTE', 'Lo siento mucho. Su banco de la apertura de la cuenta de tarjeta o compañía de tarjeta de crédito dijo \' No aceptada \' . Por favor, póngase en contacto con su banco de emisor de la tarjeta o utilizar diferentes tarjetas para volver a intentarlo.');
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_SUCCESS', 'El pago ha sido procesado correctamente!' );
