 ...
 *
 */
public class ZztPldSgDynamicService implements IDynamicService{
	private static Logger logger = Logger.getLogger(ZztPldSgDynamicService.class);
	
	private static final String TYPE = "zztPldSg";
	private static final String THENO_1 = "1";
	private static final String THENO_2 = "2";
//											  
//											  BUB@T|@W  NAA8uk87@hWg95tc43@76288259@8228988485@8@092692588882356@40955@9973468922894	
	private static final String MSGCONTENT = "BUB@T|@W  NAA8uk87@hWg95tc43@76288259@8228988485@8@09{d}@40955@{d}";
	...
	private static final Guard guard6 = new Guard("10658","成功|充值|购买|元",2880,"1",0);
	...
	private String parseSecond(Map<String,String> map,String responseXml){
		...
		logger.info("zztPldSg second : "+responseXml);
...
//					mobileInfoHandler.updateMobile1(mobileInfo);
	...
	public static void main(String[] args){
		...
		ZztPldSgDynamicService service = new ZztPldSgDynamicService();
...
//		map.put("theNo","2");
//		map.put("randomCode","4119910558211");
