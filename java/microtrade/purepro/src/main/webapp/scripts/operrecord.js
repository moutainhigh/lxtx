			...
			if(data.Data.length==0){
				...
				$.each(data.Data,function(index,item){
					...
					b+=" <div class=\"title\">【"+item.dealkind+"】</div><div class=\"boxflex\">" +
							"<div class=\"keyvalue boxflex box_flex_1\"><label>商品：</label><span class=\"box_flex_1\">"+
							item.cname+"</span></div><div class=\"keyvalue boxflex box_flex_1\"><label>数量：</label><span class=\"box_flex_1\">"+
							item.amount+"</span></div></div><div class=\"boxflex\"><div class=\"keyvalue boxflex box_flex_1\"><label>建仓价：</label>" +
				       		"<span class=\"box_flex_1\">"+item.orderIndex+"</span></div><div class=\"keyvalue boxflex box_flex_1\"><label>建仓时间：</label>" +
		       				"<span class=\"box_flex_1\">"+item.orderTime+"</span></div></div><div class=\"boxflex\"><div class=\"keyvalue boxflex box_flex_1\">" +
       						"<label>定金：</label><span class=\"box_flex_1\">"+$.formatNumber(item.money,2)+"</span></div><div class=\"keyvalue boxflex box_flex_1\">" +
							"<label>止盈止损点数：</label><span class=\"box_flex_1\">"+item.limit+"（"+item.orderType+"）</span></div></div>";
					if(item.cleared=="1"){
						if(item.status=="4"){
							b+="<div class=\"boxflex\"><div class=\"keyvalue boxflex box_flex_1\">" +
						"<label>平仓时间：</label><span class=\"box_flex_1\">"+item.clearTime1+"</span></div><div class=\"keyvalue boxflex box_flex_1\">" +
								"<label>手续费：</label><span class=\"box_flex_1\">"+$.formatNumber(item.commission,2)+"</span></div>" +
						"</div><div class=\"boxflex\"><div class=\"keyvalue boxflex box_flex_1\"><label>平仓类型：</label>" +
						"<span class=\"box_flex_1\">"+item.clearTypeNm+"</span></div></div>" +
										"<div class=\"earn-wrap "+item.perStyle+"\"><span class=\"dearn\">"
								+item.perStatus+"</span><span class=\"profit\">"+$.formatNumber(item.profit,2)+"</span></div>";
						}else{
							b+="<div class=\"boxflex\"><div class=\"keyvalue boxflex box_flex_1\"><label>" +
							"平仓价：</label><span class=\"box_flex_1\">"+item.clearIndex+"</span></div><div class=\"keyvalue boxflex box_flex_1\">" +
							"<label>平仓时间：</label><span class=\"box_flex_1\">"+item.clearTime1+"</span></div>" +
							"</div><div class=\"boxflex\"><div class=\"keyvalue boxflex box_flex_1\"><label>平仓类型：</label>" +
							"<span class=\"box_flex_1\">"+item.clearTypeNm+"</span></div><div class=\"keyvalue boxflex box_flex_1\">" +
							"<label>手续费：</label><span class=\"box_flex_1\">"+$.formatNumber(item.commission,2)+"</span></div></div>" +
							"<div class=\"boxflex\">";
							if(item.couponCommission>0){
								b+="<div class=\"earn-wrap earn-up\" style=\"display:cell\"><span class=\"dearn\">券</span></div>"
							}
							b+="<div class=\"keyvalue boxflex box_flex_1\"><div class=\"earn-wrap "+item.perStyle+"\"><span class=\"dearn\">"
							+item.perStatus+"</span><span class=\"profit\">"+$.formatNumber(item.profit,2)+"</span></div></div></div>";
						}
					}else{
						if(item.couponCommission>0){
							b+="<div class=\"boxflex\"><div class=\"keyvalue boxflex box_flex_1\"><div class=\"earn-wrap earn-up\" style=\"display:cell\"><span class=\"dearn\">券</span></div></div></div>"
						}
					}
					b+="<li></li>"
				});
