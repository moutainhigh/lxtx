...
public class KCreatorUtil {
	private static final Logger logger = LoggerFactory.getLogger(KCreatorUtil.class);
	...
	public void KCreatorFactory(int type, String now) throws SQLException {
		...
		if (ss.getHours() >= 4 && ss.getHours() < 8) {
			...
			for (CloudTarget cloudTarget : subjects) {
				...
				List<CloudTargetIndexMinute> list = CloudTargetIndexMinuteDao.queryIndexsByIndex(cloudTarget.getName(),
	...
	public static void main(String[] args) {
		Date date1 = TimeUtil.parseStringToDate("2016-11-11 19:50:00");
		batchInsertHistoryData(date1, 5);
		Date date2 = TimeUtil.parseStringToDate("2016-11-11 20:00:00");
		batchInsertHistoryData(date2, 15);
		Date date3 = TimeUtil.parseStringToDate("2016-11-11 20:00:00");
		batchInsertHistoryData(date3, 30);
		Date date4 = TimeUtil.parseStringToDate("2016-11-10 9:00:00");
