...
public class ShopService extends BaseService {
	...
	public PubExchangeLog getContactInfo(final Integer id) {
		final List<PubExchangeLog> list = this.dao.findByHql("from PubExchangeLog where uid =:uid order by id desc",
	...
	public void doExchage(final Integer uid, final Integer shopId, final String name, final String address,
			final String mobile) {
