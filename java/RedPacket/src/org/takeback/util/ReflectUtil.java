...
public class ReflectUtil
{
    ...
    static {
        ...
        Class[] classArr = new Class[]{Integer.class, Character.class, Boolean.class, Long.class, Float.class,
				Double.class, Character.class, Byte.class, Short.class, String.class, Date.class,
				Timestamp.class, BigDecimal.class, java.sql.Date.class, Time.class };
        List<Class<?>> classList = Lists.newArrayList();
        for (Class clazz:classArr) {
        	classList.add(clazz);
        }
        Builder<Class<?>> builder = ImmutableSet.builder();
        builder.addAll(classList);
        PrimitiveBigTypes = builder.build();
    }
}
