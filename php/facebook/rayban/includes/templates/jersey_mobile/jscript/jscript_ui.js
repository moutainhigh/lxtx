		...
		this.cj=function(){
			...
			if(typeof(ob.css)=='string'){
				...
				if(ob.css=='ui_confirm'){
					this.G_d.innerHTML='<p class="ui_msg">'+ob.s+'</p><p class="ui_p"><input type="button" class="ui_button" value="OK" /><input type="button" class="ui_button ui_button_r" value="Cancel" /></p>';
