...
<form name="myform" action="" method="post" enctype="multipart/form-data">
  <table width="100%" cellspacing="0">
		...
		<tr>
            ...
            <span class="lr10">还能sdssd输入<b id="texttitle2">100</b>个字符</span>
            </td>
		</tr>
		   <tr>
		 ...
		 <tr>
        	<td width="120" align="right">状态（默认展示）:</td>
            <td>	
            <input type="radio" value="0" name="status" <?php if ($wapone['status'] == 0): ?>
            	checked
            <?php endif ?>>否
             <input type="radio" value="1" name="status" <?php if ($wapone['status'] == 1): ?>
             	checked
             <?php endif ?>>是
