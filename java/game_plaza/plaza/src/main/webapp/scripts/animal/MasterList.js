...
function showMasterList(masterList){
	...
	layer_master_list_background.graphics.drawRect(1, "#162737", [0, 0, SCREEN_WIDTH, 765], true, "#162737");
	...
	layer_master_title.graphics.drawRect(1, "#162737", [0, 0, SCREEN_WIDTH, 90], true, "#162737");
	...
	layer_section.graphics.drawRect(1, "#162737", [0, 0, SCREEN_WIDTH, 90], true, "#162737");
	layer_section.y = 91;
	...
	layer_master_list_background.addChild(layer_conetnt);
	layer_conetnt.x = 0;
	layer_conetnt.y = 180;
	...
	for (var i = 0; i < masterList.length; i++){
		...
		rank += 1;
		layer_conetnt.insertChildView(masterItem(rank, user.chips, user.name, color));
	}
