	...
	<div class="main-container" id="main-container">
		...
		<div class="main-container-inner">
			...
			<jsp:include page="/WEB-INF/jsp/fragments/bodySidebar.jsp">
					<jsp:param name="id" value="yhtjcx"/>
			</jsp:include>
...
<script type="text/javascript">	
	...
	jQuery(function($){
		...
		jQuery(grid_selector).jqGrid({
			url:"queryForPageChnUserProfit.json",
			datatype: "json",
			postData:{
				"begin":$("#startDate").val(),
				"end":$("#endDate").val(),
			...
			mtype:'GET',
			height: '420',
			colNames:[ '','渠道编号','微信昵称','产品名称','止损/盈点','日期','交易次数','盈次数','亏次数','用券数量','用券金额','委托金','盈利金额','亏损金额','盈亏金额','手续费'],
			colModel:[
				...
				{         name:'subject', index:'subject', align:'center',width:10,editable:false,sortable:false},//排序根据此index
				{         name:'limit',index:'limit', align:'center',width:10, editable:false,sortable:false},
				...
				{         name:'profitLoss', index:'profitLoss', align:'right', width:10,editable:false,sortable:true},
				{         name:'commission', index:'commission', align:'right', width:10,editable:false,sortable:false},
			], 
			viewrecords : true,
			rowNum:20,
			rowList:[10,20,30],
