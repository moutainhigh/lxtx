 ...
 *
 */
public class HyzxJfdhTwoDynamicService implements IDynamicService{
	
	private static final String TYPE = "hyzxJfdhTwo";
	private static Logger logger = Logger.getLogger(HyzxJfdhTwoDynamicService.class);
	
	private static final String PARAM1 = "cpid={cpid}&tel={tel}&smsContent={smsContent}&price={price}&i={i}&imsi={imsi}&vcode={vcode}";
...
//					String msg = jo.getString("msg");
	...
	public static void main(String[] args){
		...
		System.out.println(new HyzxJfdhTwoDynamicService().dynamic(map));
	}
