...
class WxPayConf_pub
{
	...
	const APPID = 'wx17b66880acadf8bf';
	//受理商ID，身份标识
	const MCHID = '1333835901';
	//商户支付密钥Key。审核通过后，在微信发送的邮件中查看
	const KEY = 'FJYfjyabc123321qwe520123qwe82032';
	//JSAPI接口中获取openid，审核后在公众平台开启开发模式后可查看
	const APPSECRET = 'f7225200f9f34103e3fcef6f2616eb60';


	//=======【JSAPI路径设置】===================================
	//获取access_token过程中的跳转uri，通过跳转将code传入jsapi支付页面
	const JS_API_CALL_URL = 'http://www.alicom.vip/demo/js_api_call.php';
