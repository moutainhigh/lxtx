...
public class Room implements Item
{
    ...
    public synchronized void join(final User user) {
    	logger.warn("user " + user.getNickName() + " is joining the room:" + this.getName());
    ...
    public void left(final User user) {
    	logger.warn("user " + user.getNickName() + " has left room: " + this.getName());
    ...
    public Integer getLimitNum() {
        return (this.limitNum == null) ? 20 : this.limitNum;
    }
...
//    @JsonIgnore
    ...
    public Integer getPosition() {
    	if (Strings.isNullOrEmpty(this.getPsw()) || this.getCatalog().equals("C03")) {
