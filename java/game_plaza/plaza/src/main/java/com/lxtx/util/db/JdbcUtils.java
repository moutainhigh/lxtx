...
public class JdbcUtils {
	...
	//域名配置数据库
	private static ComboPooledDataSource domainDs = null;
	private static ComboPooledDataSource dsStats = null;
	...
	// 在静态代码块中创建数据库连接池
	static {
		ds = getDataSourceByConfig("/config/redpacket.properties");
		domainDs = getDataSourceByConfig("/config/domain.properties");
		dsStats = getDataSourceByConfig("/config/statsdb.properties");
	}
	...
	//返回域名数据源
	public static DataSource getDomainDataSource() {
		return domainDs;
	}
	
	public static DataSource getStatsDataSource() {
		return dsStats;
	}
