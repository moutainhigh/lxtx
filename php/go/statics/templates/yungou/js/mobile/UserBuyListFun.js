                ...
                if (q.code == 0) {				 
                    ...
                    for (var p = 0; p < r; p++) {
                        ...
                        if (m == 1) {
						  ...
						  var reg = /^http/i;
                            if(reg.test(n[p].thumb)){
                                var imgpath = n[p].thumb;
                            }else{
                                var imgpath = Gobal.imgpath+'/uploads/'+n[p].thumb;
                            }

                        o += '<img src="' + Gobal.LoadPic + '" src2="'+imgpath+'" border=0 alt=""></a><div class="u-sgl-r "><p class="z-sgl-tt"><a class="gray6">(第' + n[p].shopqishu + "期)" + n[p].shopname + "</a></p>";
