...
<?php  
  ...
  <tr>
			<td align="right" style="width:120px"><font color="red">*</font>分类类别：</td>
			<td>
            	<select id="sgid" name="sgid" class="wid100">                	
                	<option value="<?php echo $shopinfo['sgid']; ?>">

<?php foreach($cag as $sg){

if ($shopinfo['sgid']==$sg['id']) {
   echo $sg['name'];
}
