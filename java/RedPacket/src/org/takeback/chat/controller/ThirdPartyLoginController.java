...
public class ThirdPartyLoginController
{
    ...
    public ModelAndView apply(@RequestBody final Map<String, Object> params, final HttpSession session) {
        ...
        switch (s) {
            case "wx": {
                ...
                final Map<String, Object> extras = (Map)params.get("extras");
    ...
    public ModelAndView autoLogin(@RequestBody final Map<String, Object> params, final HttpServletRequest request, final HttpSession session) {
        ...
        if (user.getWbOpenId() != null) {
            ...
            final ModelAndView mav = this.doWxLogin(user.getWxRefreshToken(), user.getWxOpenId(), request, session);
            if (mav != null) {
                return mav;
            }
        }
    ...
    public ModelAndView onCodeReturn(@RequestParam final String code, final HttpServletRequest request, final HttpSession session) {
        ...
        final ModelAndView mav = this.doWxLogin(resultObject.getString("refresh_token"), resultObject.getString("openid"), request, session);
        if (mav != null) {
            return mav;
        }
    ...
    private ModelAndView doWxLogin(final String refreshToken, final String openId, final HttpServletRequest request, final HttpSession session) {
    ...
    private String getRedirectUrl(final HttpSession session) {
        ...
        if (extras != null) {
            ...
            final Map<String, String> params = (Map)extras.get("fromParams");
