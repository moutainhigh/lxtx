 ...
 */
  ...
  if (strtolower(IMAGE_USE_CSS_BUTTONS) == 'yes') {
    ...
    $content .= zen_draw_input_field('keyword', '', 'size="6" maxlength="30" class="stxt" value="' . HEADER_SEARCH_DEFAULT_TEXT . '" onfocus="if (this.value == \'' . HEADER_SEARCH_DEFAULT_TEXT . '\') this.value = \'\';" onblur="if (this.value == \'\') this.value = \'' . HEADER_SEARCH_DEFAULT_TEXT . '\';"') . zen_draw_pull_down_menu('categories_id', zen_get_categories(array(array('id' => '', 'text' => 'All Categories')), '0' ,'', '1'), $sData['categories_id']) . zen_draw_hidden_field('inc_subcat', '1') . '<input type="image" src="' . DIR_WS_TEMPLATE . 'images/search.png" class="sbtn" />';
  }
