 ...
 *
 */
public class XmwtDmDynamicService implements IDynamicService{

	private static final String TYPE = "xmwtDm";
	...
	private static void test2(){
		String url = "http://218.241.153.11/dm/getdmmsg82.php";
		...
		System.out.println(new XmwtDmDynamicService().dynamic(map));
	}
	
	private static void test1(){
		String url = "http://218.241.153.11/dm/get5dmmsg.php";
