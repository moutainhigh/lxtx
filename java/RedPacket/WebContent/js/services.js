angular.module('starter.services', [])
    ...
    .factory('UserService', function ($req, $window, $rootScope, $timeout) {
        return {
            ...
            getFillExchangeDetails: function (pageNo, pageSize) {
            	return $req.get('/user/myFillExchangeDetails', {pageNo: pageNo, pageSize: pageSize});
            },
            ...
            applyRoomShort: function(data) {
            	//alert(data.type+data.money+data.number);
            	return $req.post('/user/roomApplyShort', data);
            },
            getServerPrice: function () {
            	return $req.get('/user/getServerPrice');
            },
            applyExchangeCard: function(data) {
            	return $req.post('/user/exchangeCard', data);
            },
