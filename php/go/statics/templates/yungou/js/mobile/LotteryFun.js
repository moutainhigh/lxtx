            ...
            var p = function(t) {
                ...
                for (var r = t.length - 1; r > -1; r--) {
                    ...
                    if(reg.test( s.thumb )){
                        ...
                        var imgpath = Gobal.imgpath+'/uploads/'+ s.thumb ;
                    }
                    ...
                    if (e.indexOf("," + s.id + ",") < 0) {
                        ...
                        var u = $('<ul class="rNow rFirst" id="' + s.id + '"><li class="revConL"><img src="'+imgpath+ '"></li><li class="revConR"><h4>(第' + s.qishu + "期)" + s.title + "</h4><h5>价值：￥" + CastMoney(s.money) + '</h5><p name="pTime"><s></s>揭晓倒计时 <strong><em>00</em> : <em>00</em> : <em>0</em><em>0</em></strong></p><b class="fr z-arrow"></b></li><div class="rNowTitle">正在揭晓</div></ul>');
