...
<div class="ware fl" style="width:24%; float:left;height:275px;">
<div style="height:205px;"><a class="product-image"  href="<?php echo zen_href_link(zen_get_info_page($flash_page_items[$i]['products_id']), 'products_id=' . $flash_page_items[$i]['products_id']);?>"><?php echo zen_image(DIR_WS_IMAGES . $flash_page_items[$i]['products_image'], $flash_page_items[$i]['products_name'], 200, 200); ?></a></div>
<div class="proname"><a href="<?php echo zen_href_link(zen_get_info_page($flash_page_items[$i]['products_id']), 'products_id=' . $flash_page_items[$i]['products_id']);?>"><?php echo substr($flash_page_items[$i]['products_name'],0,2000); ?></a></div>
<?php /*?><div class="listingDescription"></div><?php */?>
<!--<div class="similar-price-box"><?php //echo zen_get_products_display_price($flash_page_items[$i]['products_id']); ?></div>-->
