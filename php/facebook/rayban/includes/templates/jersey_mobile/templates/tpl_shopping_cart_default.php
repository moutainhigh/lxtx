...
<div class="backgroundOuter contInner" id="shoppingCartDefault">
<?php
...
<div class="clear">
  ...
  <div class="buttonRow forward"><?php echo '<a href="' . zen_href_link(FILENAME_SHOPPING_CART, '', 'NONSSL') . '#quickbuy">' . zen_image_button(BUTTON_IMAGE_CHECKOUT, BUTTON_CHECKOUT_ALT) . '</a>'; ?></div>
...
if ($product['flagShowFixedQuantity']) {
	echo $product['showFixedQuantityAmount'] . ($product['buttonUpdate'] == '' ? '' : $product['buttonUpdate']) . '<p class="alert bold">' . $product['flagStockCheck'] . '</p>' . $product['showMinUnits'];
} else {
	echo $product['quantityField'] . ($product['buttonUpdate'] == '' ? '' : $product['buttonUpdate']) . '<p class="alert bold">' . $product['flagStockCheck'] . '</p>' . $product['showMinUnits'];
}
?>
    </td>
    <td class="cartUnitDisplay"><?php echo $product['productsPriceDesc']; ?></td>
    <td class="cartTotalDisplay"><?php echo $product['productsFinalPrice']. '/' .'<br/><span style="text-decoration:line-through;color:red;">'.$product['productsPrice'].'</span>'; ?></td>
...
<?php /*//start without account ?>
  ...
  <?php } ?>
      <p class="verisign clearBoth"><a href="http://www.truste.com/"  target="_blank"  rel="nofollow"><img src="<?php echo DIR_WS_TEMPLATE.'images/truste.gif';?>" alt="truste" /></a> &nbsp;&nbsp;<a href="http://www.verisign.com/" target="_blank" rel="nofollow"><img src="<?php echo DIR_WS_TEMPLATE.'images/verisign.gif';?>" alt="verisign" /></a></p>
    </div>
...
<div class="back"><?php echo zen_back_link() . zen_image_button(BUTTON_IMAGE_CONTINUE_SHOPPING, BUTTON_CONTINUE_SHOPPING_ALT) . '</a>'; ?></div>

<?php echo zen_image_submit(BUTTON_IMAGE_CONFIRM_ORDER, BUTTON_CONFIRM_ORDER_ALT, ''); ?></div>
</form>
