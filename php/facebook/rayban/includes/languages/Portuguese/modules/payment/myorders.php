...
//card info 卡信息
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_CREDIT_CARD_NUMBER', 'Número de Cartão:' );
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_CREDIT_CARD_CVV', 'CVV2/CSC:' );
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_MONTH', 'mês' );
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_YEAR', 'ano' );
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_NAME', 'nome no cartão' );
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_CARD', 'Credit Card' );
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_CREDIT_CARD_EXPIRES', 'Data Expirada:' );

//js info 提示错误
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_JS_MYORDERS_NAME', '* Nome é obrigatório!\n' );
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_JS_MYORDERS_NUMBER', '* Número do cartão de crédito está incorreta !\n' );
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_JS_MYORDERS_NUMBER_01', '* Tipo de cartão de crédito não é suportada ! \n' );
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_JS_MYORDERS_EXPIRES_MONTH', '* Validade do mês está incorreta !\n' );
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_JS_MYORDERS_EXPIRES_YEAR', '* Validade do ano está incorreto !\n' );
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_ERROR', 'Credit Card Error:' );
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_JS_MYORDERS_CVV', '* Código de Segurança incorreto !\n' );
...
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_SUCCESS', 'Parabéns, o pagamento for bem sucedida !' );
