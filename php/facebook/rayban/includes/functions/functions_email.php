...
//  $file_holder = str_replace(array("\r\n", "\n", "\r", "\t"), '', $file_holder);
	...
	if (!isset($block['EMAIL_HTTP_SERVER']) || $block['EMAIL_HTTP_SERVER'] == '')	$block['EMAIL_HTTP_SERVER'] = HTTP_SERVER;
	if (!isset($block['EMAIL_DIR_CATALOG']) || $block['EMAIL_DIR_CATALOG'] == '')	$block['EMAIL_DIR_CATALOG'] = DIR_WS_CATALOG;
