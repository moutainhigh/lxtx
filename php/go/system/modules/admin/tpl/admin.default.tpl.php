...
/****************饼状图开始******************/
	var data1 = [
	        	{name : '支付宝',value : 2.00,color:'#6f83a5'},
	        	{name : '微信扫码',value : 34.00,color:'#a5c2d5'},
	        	{name : '微信手机',value : 34.00,color:'#cbab4f'},
	        	{name : '手机支付宝',value : 5.00,color:'#76a871'},
	        	{name : '转账',value : 7.00,color:'#9f7961'},
	        	{name : '财付通',value : 18.00,color:'#a56f8f'}
        	];
...
<!------------>
    ...
    <div class="div-about width30">
        ...
        <div class="title">启源中国CMS管理系统</div>
