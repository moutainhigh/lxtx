...
public class UpmpService{
	 ...
	 * @return 是否成功
	 */
	public static boolean trade(Map<String, String> req, Map<String, String> resp,String key) {
		String nvp = buildReq(req,key);
		String respString = HttpUtil.post(UpmpConfig.TRADE_URL, nvp);
		return verifyResponse(respString, resp,key);
	}
	 ...
	 * @return 是否成功
	 */
	public static boolean query(Map<String, String> req, Map<String, String> resp,String key){
		String nvp = buildReq(req,key);
	...
	public static String buildReq(Map<String, String> req,String key) {
		...
		// 生成签名结果
		String signature = UpmpCore.buildSignature(filteredReq,key);
	 ...
	 * @return 应答是否成功
	 */
	private static boolean verifyResponse(String respString, Map<String, String> resp,String key) {
		if (respString != null && !"".equals(respString)) {
			...
			boolean signIsValid = verifySignature(para,key);
