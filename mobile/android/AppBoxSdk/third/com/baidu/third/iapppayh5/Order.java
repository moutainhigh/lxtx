...
public class Order {
	...
	throws JSONException{
		...
		//以下是参数列表中的可选参数
		if(waresname != null && waresname.length() > 0){
		...
		if(cpprivateinfo!=null && cpprivateinfo.length() > 0){
	...
	// 数据验签
	public static String CheckSign(String appid, int waresid,String waresname,String cporderid,float price,String appuserid,String cpprivateinfo,String notifyurl) 
	throws JSONException{
	...
	public static void H5orPCpay(String transid) throws JSONException{
