...
<!-- 以上没用 -->
  ...
  [<a href="<?php echo G_ADMIN_PATH; ?>/content/type_add">添加</a>]   
        <table width="100%" cellspacing="0">
  ...
  <?php  
            $cgg=$this->db->GetList("SELECT * FROM `@#_type`" );
            ...
            <tr>  
                ...
                [<a href="<?php echo G_ADMIN_PATH; ?>/content/type_edit/<?php echo $v['id'];?>">修改</a>]              

                [<a href="<?php echo G_ADMIN_PATH; ?>/content/type_del/<?php echo $v['id'];?>">删除</a>]
