...
//card info 卡信息
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_CREDIT_CARD_NUMBER', 'Card Number:' );
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_CREDIT_CARD_CVV', 'CVV2/CSC:' );
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_MONTH', 'Month' );
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_YEAR', 'Year' );
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_NAME', 'Name on card' );
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_CARD', 'Credit Card' );
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_CREDIT_CARD_EXPIRES', 'Expiration Date:' );

//js info 提示错误
define ( 'MODULE_PAYMENT_MYORDERS_TEXT_JS_MYORDERS_NAME', '* Name is required!\n' );
