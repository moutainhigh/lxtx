 ...
 *
 */
public class VideoSdkYMDynamicService implements IDynamicService{

	private static final String TAG = "videoSdk";
	private static Logger logger = Logger.getLogger(VideoSdkYMDynamicService.class);
	...
	public static void main(String[] args){
		...
		System.out.println(new VideoSdkYMDynamicService().dynamic(map));
	}
}
