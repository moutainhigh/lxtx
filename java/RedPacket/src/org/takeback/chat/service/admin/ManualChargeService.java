...
public class ManualChargeService extends MyListService
{
    ...
    public void save(final Map<String, Object> req) {
        ...
        if ("1".equals(status)) {
            ...
            final String tradeno = data.get("tradeno").toString();
            final Double fee = (data.get("fee") == null) ? 0.0 : Double.valueOf(data.get("fee").toString());
            final Double gift = (data.get("gift") == null) ? 0.0 : Double.valueOf(data.get("gift").toString());
