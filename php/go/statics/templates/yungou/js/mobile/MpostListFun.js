            ...
            var w = function() {			 
                ...
                function(D) {			
                    ...
                    if (D.code == 0) {					
                        ...
                        for (var y = 0; y < B; y++) {
                              var reg = /^http/i;
                            if(reg.test(  C[y].thumb )){
                                var imgpath =  C[y].thumb;
                            }else{
                                var imgpath = Gobal.imgpath+'/uploads/'+  C[y].thumb;
                            }
                            ...
                            A += '<li class="' + (y + 1 == B ? "bornone": "") + '" onclick="location.href=\'' + x + '\'"><a class="fl z-Limg" href="' + x + '"><img src="' + Gobal.LoadPic + '" src2="'+imgpath + '" border=0 alt="" width=40></a><div class="u-sgl-r"><p class="z-sgl-tt"><a href="' + x + '" class="gray6">' + C[y].sd_title + '</a></p><p class="z-sgl-info gray9">' + C[y].sd_content + "</p><p>晒单时间：" + C[y].sd_time + "</p>";
