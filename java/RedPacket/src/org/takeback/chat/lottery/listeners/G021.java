...
public class G021 extends G02
{
    ...
    private void dealGame(final Lottery lottery) throws GameException {
        ...
        this.game02Service.changeMoney(addMap, lottery, this.getDeposit(room), this.getDeposit(room) * lottery.getNumber(), water.doubleValue());
        System.out.println("---------------->" + this.game02Service.test());
