...
<body>
	...
	<div class="card-coupons">
		...
		<div class="smguize">
			<h4>使用说明：</h4>
			<p>
				面额：{{item.rate}}折/张；<br />如何领券：关注云平台，即可获得10张{{item.rate}}折优惠券，每天可使用一张；<br />如何使用：玩家购买订单满 {{item.useAmount}} 元产品时，平台会自动使用符合要求的折扣券（最高可减 300  元），该笔订单您只需付折后价就可完成建仓。<br />券的属性：<br />1.折扣劵在使用范围内可购买全部品种产品；<br />2.现金劵有效期：5个工作日；<br />3.所有优惠活动最终解释权归【九州微云】所有。
			</p>
		</div>
	</div>
